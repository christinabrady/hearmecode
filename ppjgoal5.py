...
def ppj(bread, pb, j):
    if bread <= 1 and pb < 1:
        return "Looks like I don't have lunch today; I need to buy bread and peanut butter."
    elif bread <= 1 and pb >= 1:
        return "Looks like I don't have lunch today; I need to buy bread."
    elif bread >= 2 and pb < 1: 
        return "Looks like I don't have lunch today; I need to buy peanut butter."
        ...
        return "I can make %i peanut butter sandwiches, but I need to buy jelly." % (pbsandwich)
    elif bread >= 2 and pb >= 1 and j >=1:
